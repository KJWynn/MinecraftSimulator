...
class ASet(Set[T]):
    ...
    def __contains__(self, item: T) -> bool:
        """ 
            ...
            :complexity: Best O(1), when the item is found as the first element in the array
                         Worst O(N), where N is the number of elements in the set
        """
    ...
    def add(self, item: T) -> None:
        ...
        if item not in self: # __contains__ 
